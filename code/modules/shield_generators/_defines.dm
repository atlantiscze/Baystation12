...
#define MODEUSAGE_USAGE_HYPERKINETIC 1.2	// Blocks meteors and projectile based weapons. Relatively low as the shields are primarily intended as an anti-meteor countermeasure.
#define MODEUSAGE_USAGE_PHOTONIC 1.3		// Blocks energy weapons, and makes the field opaque.
#define MODEUSAGE_ORGANIC_NONHUMANS 1.5		// Blocks most organic lifeforms, with an exception being humanoid mobs. Typical uses include carps.
#define MODEUSAGE_ORGANIC_HUMANOIDS 1.5		// Blocks humanoid mobs.
