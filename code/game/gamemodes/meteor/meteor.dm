...
/datum/game_mode/meteor
	...
	config_tag = "meteor"
	required_players = 0// FOR TESTING. TODO: Set to 5				// Definitely not good for low-pop.
	votable = 1
...
/datum/game_mode/meteor/post_setup()
	...
	alert_text = "This is an automatic warning. Your facility: [using_map.full_name] is on a collision course with a nearby asteroid belt. Estimated time until impact is: [METEOR_DELAY / 60 / 2] MINUTES. Please perform necessary actions to secure your ship or station from the threat. Have a nice day."
...
/datum/game_mode/meteor/process()
	...
	if((round_duration_in_ticks >= (next_wave / 2)) && (alert_sent == 1))
		alert_sent = 2
